...
?>
    ...
    <form method="post" action="signup.php">
        ...
        <input required="required" type="text" name="login" id="login" placeholder="Identifiant" value=<?php echo $_POST['login'];?> />
        ...
        <input type="text" name="bankAccount" id="bankAccount" placeholder="Numéro de compte"/>
...
?>
    <form method="post" action="signup.php">
        ...
        <input required type="text" name="login" id="login" placeholder="Identifiant" value=<?php echo $_POST['login'];?> />
        ...
        <input required type="text" name="bankAccount" id="bankAccount" placeholder="Numéro de compte"/>
        <input type="submit" value="S'inscrire">
        <input type="reset" value="Effacer le formulaire">
    </form>
